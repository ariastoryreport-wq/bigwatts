    ...
    def _ads(self, providers):
        ...
        ads_data = [
            ...
            {'provider': providers[0], 'category': cats['panneaux-solaires'],
             ...
             'status': 'active', 'duration_estimate': '3-5 jours',
            ...
            {'provider': providers[1], 'category': cats['bornes-recharge'],
             ...
             'service_area': 'Île-de-France', 'status': 'active', 'duration_estimate': '1 jour'},
            {'provider': providers[1], 'category': cats['bornes-recharge'],
            ...
            {'provider': providers[1], 'category': cats['bornes-recharge'],
             ...
             'service_area': 'Île-de-France', 'status': 'active', 'duration_estimate': '1-2 jours'},
            ...
            {'provider': providers[2], 'category': cats['chauffe-eau-thermo'],
             ...
             'service_area': 'PACA', 'status': 'active', 'duration_estimate': '1 jour'},
            {'provider': providers[2], 'category': cats['pompe-chaleur'],
             ...
             'service_area': 'PACA', 'status': 'active', 'duration_estimate': '1-2 jours'},
            ...
            {'provider': providers[3], 'category': cats['isolation'],
             ...
             'service_area': 'Occitanie', 'status': 'active', 'duration_estimate': '1 jour'},
            {'provider': providers[3], 'category': cats['isolation'],
            ...
            {'provider': providers[3], 'category': cats['isolation'],
             ...
             'service_area': 'Occitanie', 'status': 'active', 'duration_estimate': '1-2 jours'},
            ...
            {'provider': providers[4], 'category': cats['audit-energetique'],
             ...
             'service_area': 'Nouvelle-Aquitaine', 'status': 'active', 'duration_estimate': '1 jour'},
            {'provider': providers[4], 'category': cats['audit-energetique'],
             ...
             'service_area': 'Nouvelle-Aquitaine', 'status': 'active', 'duration_estimate': '2-3 heures'},
            {'provider': providers[4], 'category': cats['audit-energetique'],
            ...
            {'provider': providers[6], 'category': cats['eolienne'],
             ...
             'service_area': 'Grand Ouest', 'status': 'active', 'duration_estimate': '5-7 jours'},
