        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/providers" className="hover:text-primary-400 transition">Prestataires</Link></li>
              <li><Link to="/register" className="hover:text-primary-400 transition">Inscription</Link></li>
            </ul>
          </div>
