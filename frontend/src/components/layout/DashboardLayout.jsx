...
import {
  ...
  Users, LifeBuoy, Bell, User, Megaphone,
...
export default function DashboardLayout({ children }) {
  ...
  const links = [
    { to: '/dashboard', icon: LayoutDashboard, label: user?.role === 'proprietaire' ? 'Mes demandes' : 'Tableau de bord', roles: ['prestataire', 'proprietaire', 'customer_service'] },
    ...
    { to: '/dashboard/cs/certifications', icon: ShieldCheck, label: 'Certifications', roles: ['customer_service'] },
    // Tickets (all)
