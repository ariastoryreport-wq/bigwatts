...
export default function CountryPickerModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full mx-4 p-8 text-center animate-in">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          {COUNTRY_OPTIONS.map((c) => (
            <button
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-brand-300 hover:shadow-card-hover transition-all duration-200 text-black dark:text-white font-semibold text-lg group"
            >
