...
export default function ProviderList() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Prestataires énergie verte</h1>
        <p className="text-gray-500">Trouvez le professionnel idéal pour votre projet</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-4 mb-6 flex flex-col sm:flex-row gap-3">
        ...
        <input
          ...
          className="px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-primary-500 outline-none sm:w-48"
          value={city}
