    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Images */}
          <div className="aspect-video bg-gradient-to-br from-primary-100 to-primary-50 rounded-xl overflow-hidden">
            {ad.image_1 ? (
          ...
          <Card className="p-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <h1 className="text-2xl font-bold text-gray-900 mt-2">{ad.title}</h1>
              </div>
              <button onClick={toggleFavorite} className="p-2 hover:bg-gray-100 rounded-lg transition">
            ...
            {ad.warranty_info && (
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-green-800">Garantie</h4>
                </div>
                <p className="text-green-700 text-sm">{ad.warranty_info}</p>
              </div>
            )}
          ...
          {/* Reviews */}
          <Card className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Avis ({reviews.length})</h3>
            {reviews.length === 0 ? (
                ...
                {reviews.map((rev) => (
                  <div key={rev.id} className="border-b pb-4 last:border-0">
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        <span className="font-medium text-gray-900">{rev.author_name || rev.author_username}</span>
        ...
        <div className="space-y-6">
          {/* Provider card */}
          <Card className="p-6">
            <h3 className="text-sm font-medium text-gray-500 mb-3">Prestataire</h3>
            ...
            <div className="space-y-3">
              ...
              {isAuthenticated && (
                <Link
                  ...
                  className="w-full border border-primary-600 text-primary-600 py-3 rounded-lg hover:bg-primary-50 transition font-medium flex items-center justify-center gap-2"
                >
                  <MessageSquare className="h-4 w-4" /> Contacter
                </Link>
              )}
              {!isAuthenticated && (
                <Link to="/login" className="w-full bg-primary-600 text-white py-3 rounded-lg hover:bg-primary-700 transition font-semibold text-center block">
          ...
          <div className="bg-white rounded-xl max-w-lg w-full p-6">
            ...
            <form onSubmit={submitQuote} className="space-y-4">
              <div>
                ...
                <textarea
                  required rows={4}
                  className="w-full px-4 py-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-primary-500"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Budget indicatif</label>
                  <input
                    type="text"
                    className="w-full px-4 py-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-primary-500"
              ...
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={() => setShowQuoteForm(false)} className="flex-1 border py-2.5 rounded-lg hover:bg-gray-50">
                  Annuler
                </button>
                <button type="submit" className="flex-1 bg-primary-600 text-white py-2.5 rounded-lg hover:bg-primary-700 font-medium">
                  Envoyer
                </button>
              </div>
            </form>
