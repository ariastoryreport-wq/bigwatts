    ...
    <DashboardLayout>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-primary-400/50 outline-none"
          ...
          {/* Short description */}
          <div>
            <label className="block text-sm font-medium text-dark-200 mb-1">Description courte</label>
          ...
          {/* Description */}
          <div>
            <label className="block text-sm font-medium text-dark-200 mb-1">Description complète *</label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-dark-200 mb-1">Type de prix</label>
            ...
            <div>
              <label className="block text-sm font-medium text-dark-200 mb-1">Prix (€)</label>
              <input type="number" step="0.01" value={form.price} onChange={set('price')}
                className="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-primary-400/50 outline-none"
                placeholder="0.00" />
            </div>
            <div>
              <label className="block text-sm font-medium text-dark-200 mb-1">Durée estimée</label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-dark-200 mb-1">Zone d'intervention</label>
          ...
          {/* Extra */}
          <div>
            <label className="block text-sm font-medium text-dark-200 mb-1">Garantie</label>
          ...
          {/* Status */}
          <div>
            <label className="block text-sm font-medium text-dark-200 mb-1">Statut</label>
            <select value={form.status} onChange={set('status')}
              className="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-primary-400/50 outline-none md:w-48">
          ...
          <div className="flex gap-3 pt-4 border-t">
            <button type="button" onClick={() => navigate('/dashboard/ads')} className="px-6 py-2.5 border rounded-lg hover:bg-dark-700">
              Annuler
            </button>
            <button type="submit" disabled={loading}
              className="px-6 py-2.5 bg-primary-400 text-dark-900 rounded-lg hover:bg-primary-300 disabled:opacity-50 font-medium">
