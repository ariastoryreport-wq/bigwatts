            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase">Ville</th>
                  <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase">Vérifié</th>
                  <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase">Inscrit le</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {filtered.map((u) => (
                  <tr key={u.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-5 py-3 text-sm text-gray-600">{u.city || '–'}</td>
                    <td className="px-5 py-3">
                      {u.is_verified ? (
